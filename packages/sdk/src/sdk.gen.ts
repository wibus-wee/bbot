...
export const getWorkspacesByIdUsage = <ThrowOnError extends boolean = false>(options: Options<GetWorkspacesByIdUsageData, ThrowOnError>) => (options.client ?? client).get<GetWorkspacesByIdUsageResponses, GetWorkspacesByIdUsageErrors, ThrowOnError>({
    requestValidator: async (data) => await zGetWorkspacesByIdUsageData.parseAsync(data),
...
export const getRunsRecovery = <ThrowOnError extends boolean = false>(options?: Options<GetRunsRecoveryData, ThrowOnError>) => (options?.client ?? client).get<GetRunsRecoveryResponses, GetRunsRecoveryErrors, ThrowOnError>({
    requestValidator: async (data) => await zGetRunsRecoveryData.parseAsync(data),
    url: '/runs/recovery',
    ...options
});
