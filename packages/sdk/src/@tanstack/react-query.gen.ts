...
export const getRunsRecoveryQueryKey = (options?: Options<GetRunsRecoveryData>) => createQueryKey('getRunsRecovery', options);

export const getRunsRecoveryOptions = (options?: Options<GetRunsRecoveryData>) => queryOptions<GetRunsRecoveryResponse, GetRunsRecoveryError, GetRunsRecoveryResponse, ReturnType<typeof getRunsRecoveryQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getRunsRecovery({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
